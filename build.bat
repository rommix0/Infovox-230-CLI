...
cd /d "%~dp0"
cl.exe /nologo /W3 /EHsc /D_CRT_SECURE_NO_WARNINGS /I. main.cpp audioout.cpp audioin.cpp ctools.cpp vreg.cpp /link /OUT:speak.exe user32.lib gdi32.lib ole32.lib oleaut32.lib winmm.lib advapi32.lib uuid.lib
